...
@Service
public class GatherPayWeChatWapImpl implements IPayRealizeSv {

    private static final Logger log = LoggerFactory.getLogger(GatherPayWeChatWapImpl.class);
    /**
     * 商户编号
     */
    private static final String MCH_ID = "2216076453";

    private  String URL = "http://api.utonc1.com/api/pay/createOrder";

    private static final String MACH_KEY = "uHWkR45EncUeS04si47L6Lpsr/R8x5rSsRoQiENIo1qhwrgU90mhXQ==";

    private static final String PUB_KEY = "RlC9FFIlzjX0e9X8UAMdG/tFsfkp9sQIy49g5y2zmKL40d9nErjVew==";

    private static final String payType = "WX_H5";
    ...
    public JsonObject gateway(PayPlatform payPlatform, RechargeOrder order, Map<String, String> params) {
        ...
        try {
            ...
            String sign = toSign(MACH_KEY, treeMap);// md5 签名
    ...
    public String callback(PayPlatform payPlatform, Map<String, String> params) {
        ...
        String toSign = toSign(PUB_KEY, map);// md5 签名
