...
@Service
public class BirdPayUnionPayWapImpl implements IPayRealizeSv {

    private static final Logger log = LoggerFactory.getLogger(BirdPayUnionPayWapImpl.class);


    private static final String PAYTYPE = "UNIONPAY";
