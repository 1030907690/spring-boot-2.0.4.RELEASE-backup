...
@Service
public class GatherPayUnionPayWapImpl implements IPayRealizeSv {

    private static final Logger log = LoggerFactory.getLogger(GatherPayUnionPayWapImpl.class);


    private static final String payType = "YL_WP";
