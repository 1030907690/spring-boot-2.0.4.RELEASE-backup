...
@Service
public class BirdPayWeChatWapImpl implements IPayRealizeSv {

    private static final Logger log = LoggerFactory.getLogger(BirdPayWeChatWapImpl.class);


    private static final String PAYTYPE = "WEIXIN";
