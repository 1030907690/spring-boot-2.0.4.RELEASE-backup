 ...
 * @date 2018年7月30日11:37:30
 */
@Service
public class GatherPayQQPayWapImpl implements IPayRealizeSv {

    private static final Logger log = LoggerFactory.getLogger(GatherPayQQPayWapImpl.class);


    private static final String payType = "QQ";
